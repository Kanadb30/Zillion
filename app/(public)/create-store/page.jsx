...
text-slate-400">
                <h1 className="text-2x1 sm:text-4xl font-semibold">Please <span
            ...
            {!alreadySubmitted ? (
                <div className="mx-6 min-h-[70vh] my-16">
                    <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Submitting data..." })} className="max-w-7xl mx-auto flex flex-col items-start gap-3 text-slate-500">
                        {/* Title */}
                        <div>
                            <h1 className="text-3xl text-gray-300">Add Your <span className="text-white font-medium">Store</span></h1>
                            <p className="max-w-lg">To become a seller on Zillion, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
