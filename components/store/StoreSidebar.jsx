            ...
            <div className="max-sm:mt-6">
                {
                    sidebarLinks.map((link, index) => (
                        <Link key={index} href={link.href} className={`relative flex items-center gap-3 text-slate-500 hover:bg-[#779efc] p-2.5 transition ${pathname === link.href && 'bg-[#970319] sm:text-slate-600'}`}>
